...
public class MCreatorApollosBow extends Elementsgreekgods.ModElement {
	@GameRegistry.ObjectHolder("greekgods:apollosbow")
	public static final Item block = null;
	public static final int ENTITYID = 5;

	public MCreatorApollosBow(Elementsgreekgods instance) {
		super(instance, 53);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityArrowCustom.class)
				.id(new ResourceLocation("greekgods", "entitybulletapollosbow"), ENTITYID).name("entitybulletapollosbow").tracker(64, 1, true)
				.build());
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("greekgods:apollosbow", "inventory"));
	}
	...
	public static class RangedItem extends Item {
		public RangedItem() {
			...
			setMaxDamage(100);
			setFull3D();
			setUnlocalizedName("apollosbow");
			setRegistryName("apollosbow");
			maxStackSize = 1;
	...
	public static class EntityArrowCustom extends EntityTippedArrow {
		...
		protected void arrowHit(EntityLivingBase entity) {
			...
			World world = this.world;
			{
				...
				MCreatorApollosBowBulletHitsLivingEntity.executeProcedure($_dependencies);
			}
		}
