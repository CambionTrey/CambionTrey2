...
public class MCreatorWut extends Elementsgreekgods.ModElement {
	@GameRegistry.ObjectHolder("greekgods:wut")
	public static final Item block = null;

	public MCreatorWut(Elementsgreekgods instance) {
		super(instance, 29);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
				...
				int z = (int) entity.posZ;
				{
					...
					MCreatorZuessironRightClickedInAir.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public EnumActionResult onItemUse(EntityPlayer entity, World world, BlockPos pos, EnumHand hand, EnumFacing direction, float hitX,
				...
				{
					java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
					MCreatorZuessironRightClickedOnBlock.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setUnlocalizedName("wut").setRegistryName("wut").setCreativeTab(MCreatorGreekGoditem.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("greekgods:wut", "inventory"));
	}
