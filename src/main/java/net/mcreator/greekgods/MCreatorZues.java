...
public class MCreatorZues extends Elementsgreekgods.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;

	public MCreatorZues(Elementsgreekgods instance) {
		super(instance, 21);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("greekgods", "zues"), ENTITYID)
				.name("zues").tracker(64, 1, true).egg(-10027009, -16711681).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelZombie(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("greekgods:textures/zeus-13774876.png");
				}
			};
	...
	public static class EntityCustom extends EntityIronGolem {
		public EntityCustom(World world) {
			...
			this.targetTasks.addTask(3, new EntityAINearestAttackableTarget(this, MCreatorHadesmob.EntityCustom.class, true, false));
		...
		protected Item getDropItem() {
			return new ItemStack(MCreatorElectricIron.block, (int) (1)).getItem();
		}
